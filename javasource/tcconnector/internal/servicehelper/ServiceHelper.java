...
/**
 * ServiceHelper class helps do common things required by Java actions implemented
 * using JSON based CallTeamcenterService method.
 */
public class ServiceHelper
{
	...
	public ServiceHelper( IContext context,
			              java.lang.String ServiceName,
			              IMendixObject InputArgument,
			              java.lang.String ReturnType,
			              java.lang.String BusinessObjectMapping )
	{
	...
	public void populateResponseWithServiceData( JSONObject jsonResponseObj,String configurationName ) throws Exception
	{
		...
		if(jsonResponseObj.has(RES_SERVICEDATA_KEY)) 
		{
			...
			IMendixObjectMember<?> member = serviceDataEntity.getMember(context, SERVICE_RESPONSE_RESPONSE_DATA_ASSOCIATION_NAME);
