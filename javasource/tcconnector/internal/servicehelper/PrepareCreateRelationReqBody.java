...
public class PrepareCreateRelationReqBody
{
	...
	public PrepareCreateRelationReqBody( IContext context,
			                             java.lang.String relationName,
			                             List<IMendixObject> primaryObjs,
			                             List<IMendixObject> secondaryObjs,
			                             List<IMendixObject> userDatas )
	{
	...
	/*
	 * Validate the input parameters. Following exceptions are thrown by this function.
	 * 
	 * InvalidInputException - If primaryObjects is null or empty or
	 * 						   If secondaryObjects is null or empty or
	 * 						   If the size of primaryObjects and secondaryObjects is not same.	 * 
	 */
	private void validateInputs() 
	{
		...
		{
			String message = "Number of objects specified for input property "+ REQ_SECONDARY_OBJECT_KEY + " and " + REQ_SECONDARY_OBJECT_KEY + " does not match.";
			throw new InvalidInputException(message);
		}
	}
