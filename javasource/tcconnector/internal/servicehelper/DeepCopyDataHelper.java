...
public class DeepCopyDataHelper
{
	 ...
	 * @throws Exception 
	 */
	public static JSONObject callGetDeepCopyDataSOA( IContext context, ModelObject targetObject, String operationName, ModelObject parentObject, String configurationName ) throws Exception
	{
		...
		return TcConnection.callTeamcenterService(context, Constants.OPERATION_GETDEEPCOPYDATA, getDeepCopyDataInput, null, configurationName);
	}
