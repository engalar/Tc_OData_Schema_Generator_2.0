...
public class MapEntry 
{
	...
	public  MapEntry(IContext context, TcMappings mappings, String entryType )  
	{
		...
		if(!isValidEntry())
		{
			Constants.LOGGER.error(entryEntity.getMetaObject().getName()+" does not have a 'key' and/or 'value' Attribute.");
	...
	public String getMemberValueName()
	{
		...
		throw new IllegalArgumentException(entryEntity.getMetaObject().getName()+" does not have a 'value' Attribute.");
	}
