...
public class CookieManager 
{
	...
	{
		List<IMendixObject> mxCookies = com.mendix.core.Core.retrieveByPath(context, tcSession.getMendixObject(), Cookie.MemberNames.Cookies.toString(), true);
	...
	private void deleteCookies()
	{
		...
		if(!deleted) {
			Constants.LOGGER.warn("Failed to delete  the cookies from " + tcSession.getUserName() + " Teamcenter session.");
		}
	}
