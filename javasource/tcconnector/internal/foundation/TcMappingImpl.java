...
public class TcMappingImpl implements TcMapping
{
	...
	@Override
	public String getMxName() {return mxName;}
	@Override
	public String toString() {return tcName+"/"+mxName;}
	@Override
	public int hashCode() 
	{
	...
	{
		if(!(right instanceof TcMapping))	return false;
		
		TcMapping that = (TcMapping)right;
		if(!this.getTcName().equals(that.getTcName())) return false;
		if(!this.getMxName().equals(that.getMxName())) return false;
		return true;
	}		
}