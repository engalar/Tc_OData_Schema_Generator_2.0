...
public class Constants 
{
	...
	public static final String OPERATION_GETTYPEDESCRIPTION = SERVICE_SESSION_1511+"/getTypeDescriptions2";
	...
	public static final String OPERATION_GETAVAILABLETYPESWITHDISPLAYNAMES	    = SERVICE_DATAMANAGEMENT_1004+"/getAvailableTypesWithDisplayNames";
	...
	public static final String OPERATION_EXPAND_GRM_RELATIONS_PRIMARY    	= SERVICE_DATAMANAGEMENT_0709+"/expandGRMRelationsForPrimary";
	public static final String OPERATION_EXPAND_GRM_RELATIONS_SECONDARY    	= SERVICE_DATAMANAGEMENT_0709+"/expandGRMRelationsForSecondary";

	public static final String SERVICE_FILEMANAGEMENT_1004  = "Core-2006-03-FileManagement";
	public static final String OPERATION_GETFILEREADTICKETS	= SERVICE_FILEMANAGEMENT_1004+"/getFileReadTickets";
	public static final String OPERATION_COMMITDATASETFILES	= SERVICE_FILEMANAGEMENT_1004+"/commitDatasetFiles";
