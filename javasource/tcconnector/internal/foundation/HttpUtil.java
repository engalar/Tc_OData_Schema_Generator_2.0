...
public class HttpUtil 
{
	...
	{
		List<IMendixObject> mxHeaders = com.mendix.core.Core.retrieveByPath(context, httpResponse.getMendixObject(), HttpHeader.MemberNames.HttpHeaders.toString(), true);
