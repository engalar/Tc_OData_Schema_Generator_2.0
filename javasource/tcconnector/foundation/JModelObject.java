 ...
 * This class has convenience methods to access property values and other elements defined on the ModelObject type.
 */
public class JModelObject extends JSONObject
{
	...
	/**
 	 * Create list of Entities with property values from the JSONArray.
	 * The {@link TcModelObjectMappings} mapping is used to map Teamcenter defined property names (keys in JSONObject)
	 *  to the Entity member (Attributes or Associations) names.
	 * 
	 * Entity member types must match the type of the Teamcenter property type.
	 * Members of type String are the display or localized value of the Teamcenter property, while Members of other
	 * types (Boolean, Localized Date and time, Decimal, and Integer), are the database value of the Teamcenter property. 
	 * To map a database value of a Teamcenter String property the member name must be suffixed with '__DB', i.e. 'description__DB' 
	 * 
	 * @param context
	 ...
	 * 
	 * @throws PropertyTypeExcpetion	 An Entity member is defined with a different type than the Teamcenter property.
	 * @throws IllegalArgumentException  There is not a Mendix Entity mapping to this business object type.
	 * 									 The JSONObject does not represent a ModelObject.
	 */
	public static List<IMendixObject> instantiateEntities( IContext context, JSONArray modelObjects, BusinessObjectMappings boMappings, String  configurationName )
	{
		...
		for(int i=0;i< modelObjects.length(); i++)
		{
			...
			{
				throw new IllegalArgumentException("The JSON element does not represent a ModelObject. "+ obj.toString());
			}
		}
		return tgtEntities;
	}	
	 ...
	 * 									 The JSONObject does not represent a ModelObject.
	 */
	public static List<IMendixObject> instantiateEntities( IContext context, List<JModelObject> modelObjects, BusinessObjectMappings boMappings,String configurationName )
	{
		List<IMendixObject> tgtEntities = new ArrayList<>();
	 ...
	 * @throws IllegalArgumentException	The JSONObject does not have the required keys/fields that represent a ModelObject.
	 */
	...
	/**
	 * Construct an object from the given Entity.
	 * The JModelObject will be created with only the UID and Type information (no property values).
	 * 
	...
	/**
	 * Initialize the given Entity with property values from this JModelObject.
	 * The {@link TcModelObjectMappings} mapping is used to map the Teamcenter defined property names (keys in JSONObject)
	 * to the Entity member (Attributes or Associations) names.
	 * 
	 * Entity member types must match the type of the Teamcenter property type.
	 * Members of type String are the display or localized value of the Teamcenter property, while Members of other
	 ...
	 * 
	 * @param context
	 * @param tgtEntity		The target Entity object to initialize (must extend from ModelObject).
	 * 
	 * @throws IllegalArgumentException	The tgtEntity does not extend from the ModelObject Entity type.
	 * @throws PropertyTypeExcpetion	An Entity member is defined with a different type than the Teamcenter property.
	 */
	public void initializeEntity( IContext context, IMendixObject tgtEntity, BusinessObjectMappings boMappings,String configurationName )
	{
	...
	/**
	 * Create an Entity with property values from this JModelObject.
	 * The {@link TcModelObjectMappings} mapping is used to map  Teamcenter defined property names (keys in JSONObject)
	 * to the Entity member (Attributes or Associations) names.
	 * 
	 * Entity member types must match the type of the Teamcenter property type.
	 ...
	 * 
	 * @param context
	 * @param boMappings		The set of Teamcenter business object names to Mendix Entity names.
	 * @return The Entity object created.
	 * 
	 * @throws PropertyTypeExcpetion	An Entity member is defined with a different type than the Teamcenter property.
	 */
	public IMendixObject instantiateEntity(IContext context, String suggestedEntityName, BusinessObjectMappings boMappings,String configurationName)
	{
	 ...
	 * 
	 * @throws NotLoadedExcpetion The property has not been returned from the Teamcenter server or was returned without a UI value.
	 */
	...
	/**
	 * Gets the DB value of a given property (the property is declared as of type String in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The value of the property.
	 * 
	 * @throws NotLoadedExcpetion The property has not been returned from the Teamcenter server or was returned without a DB value.
	 */
	...
	/**
	 * Gets the DB values of a given multi-valued property (the property is declared as of type String in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The unmodifiable list of property values.
	 * 
	...
	/**
	 * Gets the DB value of a given property (the property is declared as of type Boolean in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The value of the property.
	 * 
	...
	/**
	 * Gets the DB values of a given multi-valued property (the property is declared as of type Boolean in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The unmodifiable list of property values.
	 * 
	...
	/**
	 * Gets the DB value of a given property (the property is declared as of type Date in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The value of the property.
	 * 
	...
	/**
	 * Gets the DB values of a given multi-valued property (the property is declared as of type Date in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The unmodifiable list of property values.
	 * 
	...
	/**
	 * Gets the DB value of a given property (the property is declared as of type Double in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The value of the property.
	 * 
	...
	/**
	 * Gets the DB values of a given multi-valued property (the property is declared as of type Double in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The unmodifiable list of property values.
	 * 
	...
	/**
	 * Gets the DB value of a given property (the property is declared as of type Integer in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The value of the property.
	 * 
	...
	/**
	 * Gets the DB values of a given multi-valued property (the property is declared as of type Integer in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The unmodifiable list of property values.
	 * 
	...
	/**
	 * Gets the DB value of a given property (the property is declared as of type Business Object in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The value of the property.
	 * 
	 * @throws NotLoadedExcpetion The property has not been returned from the Teamcenter server or was returned without a DB value.
	 * @throws PropertyTypeExcpetion The value cannot be accessed as a Business Object.
	 */
	...
	/**
	 * Gets the DB values of a given multi-valued property (the property is declared as of type Business Object in the Teamcenter Meta Model).
	 * 
	 * @param name		The name of the desired property value.
	 * @return			The unmodifiable list of property values.
	 * 
	...
	public List<JModelObject> getPropertyValueAsModelObjects ( String name )
	{
		...
		for(int i=0; i< dbValues.length(); i++)
		{
			try
			{
				valueList.add(PropertyResolver.parseModelObject(dbValues, i));
			}
			catch(IllegalArgumentException e)
			{
	 ...
	 * 
	 * @throws NotLoadedExcpetion The property has not been returned from the Teamcenter server or was returned without a DB value.
	 * @throws PropertyTypeExcpetion The value cannot be accessed as the desired type.
	 */
	...
	private void validateKeys( JSONObject obj )
	{
		...
		{
			Constants.LOGGER.error(LogCorrelationID.getId()+": The JSONObject does not represent a ModelObject.\n"+obj.toString());
	...
	private PropertyTypeExcpetion createPropertyTypeExcpetion( String propertyName, String expectedType, JSONArray dbValues, int index )
	{
