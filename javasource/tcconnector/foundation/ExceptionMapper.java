...
public class ExceptionMapper 
{
	...
	/** 
	 * Constructs and throws an appropriate exception base on the content of the JSONObject.
	 * If the JSON does not map to a known exception, this method returns without error.
	 * 
