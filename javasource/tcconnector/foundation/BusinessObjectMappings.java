...
/**
 * Contains the mapping between Teamcenter business object type names and Mendix Entity names.
 *
 */
public class BusinessObjectMappings 
{
	...
	/**
	 * @param allMapings A semicolon (;) separated list of Teamcenter business object names to Domain Model Entity names.
	 * 					 (BOMLine=TcConnector.BOMLine;ItemRevision=TcConnector.ItemRevision)
	 * 
	 * @throws IllegalArgumentException If one of the Domain Model names is not valid or does not extend from ModelObject
	 */
	...
	/**
	 * Get the Teamcenter business object name for the given Entity name;
	 * If the Entity is not in the mapping, a null is returned.
	 */
	 ...
	 * @param suggestedEntityName	A suggested Entity name. This is used only if the tcName does NOT have a mapped Entity name.
	 * @return The Entity name.
	 * @throws IllegalArgumentException If there is not a valid mapping for the tcName, 
	 * 									and the suggestedEntityName is not valid or does not extend from ModelObject
	 */
	...
	private void validMendixName (String mxName )
	{
		try
		{
			...
			{
				throw new IllegalArgumentException("'"+mxName+"' does not extend from '"+ModelObject.entityName+"'.");				
			}
		}
