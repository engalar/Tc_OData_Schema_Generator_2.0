...
public class MapNodeForActionParameters__ extends CustomJavaAction<java.lang.Void>
{
	private IMendixObject __odataAction;
	private schemagenerator.proxies.OdataActions odataAction;
	private IMendixObject __actionParam;
	private schemagenerator.proxies.ActionParams actionParam;

	public MapNodeForActionParameters__(IContext context, IMendixObject odataAction, IMendixObject actionParam)
	{
		super(context);
		this.__odataAction = odataAction;
		this.__actionParam = actionParam;
	}
	...
	public java.lang.Void executeAction() throws Exception
	{
		...
		this.actionParam = this.__actionParam == null ? null : schemagenerator.proxies.ActionParams.initialize(getContext(), __actionParam);
		...
		view.setViewForObjectUUID(__actionParam.getId().toLong());
		view.commit();
	...
	{
		return "MapNodeForActionParameters__";
	}
